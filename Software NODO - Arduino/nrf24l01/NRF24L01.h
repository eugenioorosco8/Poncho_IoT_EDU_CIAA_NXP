...
class NRF24L01 {
  public:
#define R_REGISTER 0b00000000 // Read a nRF24L01 Register (Register Address:AAAAA) => Instruction: 000AAAAA
#define W_REGISTER 0b00100000 // Write a nRF24L01 Register (Register Address:AAAAA) => Instruction: 001AAAAA
...
#define CONFIG_RF 0x00 // General Configuration Register
...
#define STATUS_RF 0x07 // nRF24L01 STATUS REGISTER
#define OBSERVE_TX 0x08 // Transmit observe register
#define CD 0x09 // Carrier Detect register
#define RX_ADDR_P0 0x0A // Receive Address for Data Pipe 0 (3, 4 or 5byte lenght) (used in RX Mode and TX Mode asAuto Acknowledgment Receiving Channel)
#define RX_ADDR_P1 0x0B // Receive Address for Data Pipe 1 (3, 4 or 5byte lenght) (used in RX Mode)
#define RX_ADDR_P2 0x0C // Receive Address for Data Pipe 2 (1 byte) (usedin RX Mode)
#define RX_ADDR_P3 0x0D // Receive Address for Data Pipe 3 (1 byte) (usedin RX Mode)
#define RX_ADDR_P4 0x0E // Receive Address for Data Pipe 4 (1 byte) (usedin RX Mode)
#define RX_ADDR_P5 0x0F // Receive Address for Data Pipe 5 (1 byte) (usedin RX Mode)
#define TX_ADDR 0x10 // Transmit Address (3, 4 or 5 byte lenght)(used in TX Mode)
...
// nRF24L01 CONFIG Register BIT Definition
...
// Name Bit Description
#define RX_DR 0b01000000 // Data Ready RX FIFO interrupt => Set high whennew data arrives (Write 1 to clear bit)
#define TX_DS 0b00100000 // Data Sent TX FIFO interrupt => Set high whenpacket sent on TX (Write 1 to clear bit)
#define MAX_RT 0b00010000 // Maximum number of TX retries interrupt (Write 1to clear bit)
#define RX_P_NO 0b00001110 // Data Pipe Number of the Payload Available forreading in the RX FIFO
#define PRIM_RX 0b00000001 // TX FIFO full flag

//unsigned char dataReady(void);
	NRF24L01 (unsigned char Ce, unsigned char Csn);
...
unsigned char Ce_Pin=7;
unsigned char Csn_Pin=53;
